...
from scipy._lib._util import DecimalNumber, IntNumber, _transition_to_rng
...
def sample_A_B(n, dists, rng=...):  # -> ndarray[tuple[int, int, int], dtype[Any]]:
...
def sobol_indices(*, func, n, dists=..., method=..., rng=...):  # -> SobolResult:
