...
class _PSD:
    ...
    def __init__(
        self, M, cond=..., rcond=..., lower=..., check_finite=..., allow_singular=...
    ) -> None: ...
    @property
    def pinv(self):  # -> Incomplete:
        ...
...
class multivariate_normal_gen(multi_rv_generic):
    ...
    def __init__(self, seed=...) -> None: ...
    def __call__(
        self, mean=..., cov=..., allow_singular=..., seed=..., **kwds
    ...
    def rvs(
        self, mean=..., cov=..., size=..., random_state=...
    ):  # -> ndarray[_AnyShape, dtype[float64]]:
        """Draw random samples from a multivariate normal distribution.
    ...
    def marginal(
        self, dimensions, mean=..., cov=..., allow_singular=...
    ):  # -> multivariate_normal_frozen:
        """Return a marginal multivariate normal distribution.
...
class multivariate_normal_frozen(multi_rv_frozen):
    ...
    def logcdf(self, x, *, lower_limit=..., rng=...):  # -> Any:
        ...

    def cdf(self, x, *, lower_limit=..., rng=...): ...
    ...
    def marginal(self, dimensions):  # -> multivariate_normal_frozen:
        ...
...
class matrix_normal_gen(multi_rv_generic):
    ...
    def rvs(
        self, mean=..., rowcov=..., colcov=..., size=..., random_state=...
    ):  # -> Any:
...
class matrix_t_gen(multi_rv_generic):
    ...
    def __init__(self, seed=...) -> None: ...
    def __call__(
        self, mean=..., row_spread=..., col_spread=..., df=..., seed=...
    ):  # -> matrix_t_frozen:
    ...
    def logpdf(self, X, mean=..., row_spread=..., col_spread=..., df=...):
        """Log of the matrix normal probability density function.
    ...
    def pdf(self, X, mean=..., row_spread=..., col_spread=..., df=...):  # -> Any:
...
class matrix_t_frozen:
    ...
    def rvs(self, size=..., random_state=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
...
class wishart_gen(multi_rv_generic):
    ...
    def mean(
        self, df, scale
    ):  # -> ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]] | Any:
    ...
    def var(self, df, scale):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
    ...
    def rvs(
        self, df, scale, size=..., random_state=...
    ):  # -> ndarray[_AnyShape, dtype[float64]]:
        """Draw random samples from a Wishart distribution.
...
class wishart_frozen(multi_rv_frozen):
    ...
    def var(self):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...
...
class multinomial_gen(multi_rv_generic):
    ...
    def pmf(self, x, n, p):  # -> NDArray[Incomplete]:
    ...
    def rvs(
        self, n, p, size=..., random_state=...
    ):  # -> NDArray[long] | NDArray[int64]:
        """Draw random samples from a Multinomial distribution.
...
class multinomial_frozen(multi_rv_frozen):
    ...
    def pmf(self, x):  # -> NDArray[Incomplete]:
        ...
    ...
    def rvs(self, size=..., random_state=...):  # -> NDArray[long] | NDArray[int64]:
        ...
...
class random_correlation_gen(multi_rv_generic):
    ...
    def rvs(self, eigs, random_state=..., tol=..., diag_tol=...):  # -> Incomplete:
...
class random_correlation_frozen(multi_rv_frozen):
    ...
    def rvs(self, random_state=...):  # -> Incomplete:
        ...
...
class multivariate_t_gen(multi_rv_generic):
    ...
    def __call__(
        self, loc=..., shape=..., df=..., allow_singular=..., seed=...
    ...
    def entropy(self, loc=..., shape=..., df=...):  # -> Any | Array:
    ...
    def rvs(
        self, loc=..., shape=..., df=..., size=..., random_state=...
    ):  # -> ndarray[_AnyShape, dtype[float64]]:
        """Draw random samples from a multivariate t-distribution.
    ...
    def marginal(
        self, dimensions, loc=..., shape=..., df=..., allow_singular=...
...
class multivariate_t_frozen(multi_rv_frozen):
    ...
    def entropy(self):  # -> Any | Array:
        ...

    def marginal(self, dimensions):  # -> multivariate_t_frozen:
        ...
...
class multivariate_hypergeom_gen(multi_rv_generic):
    ...
    def logpmf(self, x, m, n):  # -> ndarray[_AnyShape, dtype[Any]]:
    ...
    def pmf(self, x, m, n):  # -> NDArray[Incomplete]:
    ...
    def mean(self, m, n):  # -> ndarray[_AnyShape, dtype[Any]]:
        """Mean of the multivariate hypergeometric distribution.
    ...
    def var(self, m, n):  # -> ndarray[_AnyShape, dtype[Any]]:
        """Variance of the multivariate hypergeometric distribution.
    ...
    def cov(self, m, n):  # -> ndarray[_AnyShape, dtype[Any]]:
    ...
    def rvs(
        self, m, n, size=..., random_state=...
    ):  # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[int, ...] | Any, dtype[Any]]:
...
class multivariate_hypergeom_frozen(multi_rv_frozen):
    ...
    def logpmf(self, x):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def pmf(self, x):  # -> NDArray[Incomplete]:
        ...

    def mean(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def var(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def cov(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
...
class random_table_gen(multi_rv_generic):
    ...
    def logpmf(self, x, row, col):  # -> ndarray[_AnyShape, dtype[float64]]:
    ...
    def pmf(self, x, row, col):  # -> NDArray[Incomplete]:
    ...
    def mean(self, row, col):  # -> NDArray[float64]:
...
class random_table_frozen(multi_rv_frozen):
    ...
    def logpmf(self, x):  # -> ndarray[_AnyShape, dtype[float64]]:
        ...
...
class uniform_direction_gen(multi_rv_generic):
    ...
    def rvs(self, dim, size=..., random_state=...):
...
class dirichlet_multinomial_gen(multi_rv_generic):
    ...
    def cov(self, alpha, n):  # -> NDArray[float64]:
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    **Fitting the distribution parameters**
    ...
    def rvs(
        self, mu=..., kappa=..., size=..., random_state=...
    ):  # -> Any | NDArray[Any] | ndarray[tuple[()], dtype[float64]] | NDArray[float64]:
        """Draw random samples from a von Mises-Fisher distribution.
...
class normal_inverse_gamma_gen(multi_rv_generic):
    ...
    def rvs(
        self, mu=..., lmbda=..., a=..., b=..., size=..., random_state=...
    ):  # -> tuple[Any, Any]:
    ...
    def mean(
        self, mu=..., lmbda=..., a=..., b=...
    ):  # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[float64]]]:
        """The mean of the distribution.
    ...
    def var(
        self, mu=..., lmbda=..., a=..., b=...
    ):  # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
        """The variance of the distribution.
...
class normal_inverse_gamma_frozen(multi_rv_frozen):
    ...
    def logpdf(self, x, s2):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def pdf(self, x, s2):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
