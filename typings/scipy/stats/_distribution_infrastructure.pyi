...
class _Interval(_Domain):
    ...
    def draw(
        self, n, type_, min, max, squeezed_base_shape, rng=...
    ):  # -> _Array1D[float64] | _Array[tuple[int], Any]:
...
class _Parameter(ABC):
    ...
    def draw(
        self, size=..., *, rng=..., region=..., proportions=..., parameter_values=...
    ):  # -> ndarray[tuple[()], dtype[Any]]:
...
class _RealParameter(_Parameter):
    ...
    def validate(
        self, arr, parameter_values
    ):  # -> tuple[ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[float64]], dtype[Any] | dtype[float64], Any]:
...
class _Parameterization:
    ...
    def validation(
        self, parameter_values
    ):  # -> tuple[Any | Literal[True], Any | dtype[Any]]:
    ...
    def draw(
        self, sizes=..., rng=..., proportions=..., region=...
    ):  # -> dict[Any, Any]:
...
class UnivariateDistribution(_ProbabilityDistribution):
    ...
    _parameterizations = ...
    def __init__(
        self, *, tol=..., validation_policy=..., cache_policy=..., **parameters
    ) -> None: ...
    ...
    @property
    def tol(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        r"""positive float:
        The desired relative tolerance of calculations. Left unspecified,
        calculations may be faster; when provided, calculations may be
        more likely to meet the desired accuracy.
    ...
    def support(
        self,
    ):  # -> tuple[ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    def entropy(
        self, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    def mode(
        self, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., _Array[tuple[()], float64 | Any] | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    def pdf(
        self, x, /, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., Incomplete]:
        ...

    @_set_invalid_nan
    def logpmf(self, x, /, *, method=...):  # -> Callable[..., Any] | None:
        ...
    ...
    def logcdf(
        self, x, y=..., /, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    def logccdf(
        self, x, y=..., /, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., tuple[Any, Any] | Any]:
        ...
    ...
    @_set_invalid_nan
    def ilogcdf(self, logp, /, *, method=...):  # -> Callable[..., Any]:
        ...

    @_set_invalid_nan
    def icdf(self, p, /, *, method=...):  # -> Callable[..., Any]:
        ...
    ...
    def iccdf(
        self, p, /, *, method=...
    ):  # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any]:
        ...
...
def make_distribution(
    dist,
):  # -> type[scipy.stats._distribution_infrastructure.CustomDistribution]:
...
class Mixture(_ProbabilityDistribution):
    ...
    @property
    def weights(self):  # -> ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
        ...

    def support(
        self,
    ):  # -> tuple[ndarray[tuple[()], dtype[Any]] | NDArray[Incomplete], ndarray[tuple[()], dtype[Any]] | NDArray[Incomplete]]:
        ...

    def logentropy(self, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def entropy(self, *, method=...): ...
    def mode(self, *, method=...): ...
    def median(self, *, method=...): ...
    def mean(self, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...

    def variance(self, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def standard_deviation(self, *, method=...):  # -> NDArray[float64]:
        ...

    def skewness(self, *, method=...):  # -> NDArray[float64]:
        ...

    def kurtosis(self, *, method=...):  # -> NDArray[float64]:
        ...

    def moment(self, order=..., kind=..., *, method=...): ...
    def pdf(self, x, /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...

    def logpdf(self, x, /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def pmf(self, x, /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...

    def logpmf(self, x, /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...

    def cdf(
        self, x, y=..., /, *, method=...
    ):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...

    def logcdf(self, x, y=..., /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
    ...
    def logccdf(self, x, y=..., /, *, method=...):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
