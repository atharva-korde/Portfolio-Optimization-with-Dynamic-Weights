...
@xp_capabilities(
    cpu_only=True, skip_backends=[("dask.array", "typical dask issues")], jax_jit=False
)
@_axis_nan_policy_factory(
    CramerVonMisesResult, n_samples=1, too_small=1, result_to_tuple=_cvm_result_to_tuple
)
def cramervonmises(rvs, cdf, args=..., *, axis=...):  # -> CramerVonMisesResult:
...
@_axis_nan_policy_factory(
    CramerVonMisesResult, n_samples=2, too_small=1, result_to_tuple=_cvm_result_to_tuple
)
def cramervonmises_2samp(x, y, method=..., *, axis=...):  # -> CramerVonMisesResult:
...
class TukeyHSDResult:
    ...
    def __init__(self, statistic, pvalue, _ntreatments, _df, _stand_err) -> None: ...
...
@xp_capabilities(np_only=True)
def tukey_hsd(*args, equal_var=...):  # -> TukeyHSDResult:
