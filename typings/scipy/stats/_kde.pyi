...
class gaussian_kde:
    ...
    def integrate_box(self, low_bounds, high_bounds, maxpts=..., *, rng=...):  # -> Any:
    ...
    def resample(self, size=..., seed=...):  # -> NDArray[float64]:
    ...
    @property
    def weights(self):  # -> ndarray[_AnyShape, dtype[Any]] | Any:
        ...
