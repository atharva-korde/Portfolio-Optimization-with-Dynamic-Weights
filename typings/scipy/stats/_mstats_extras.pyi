...
def hdquantiles(
    data, prob=..., axis=..., var=...
):  # -> MaskedArray[tuple[int, int], dtype[float64]]:
    """
...
def hdmedian(data, axis=..., var=...):  # -> MaskedArray[_AnyShape, dtype[float64]]:
    """
...
def hdquantiles_sd(
    data, prob=..., axis=...
):  # -> MaskedArray[tuple[int], dtype[float64]]:
    """
...
def trimmed_mean_ci(
    data, limits=..., inclusive=..., alpha=..., axis=...
):  # -> NDArray[Any]:
    """
...
def mjci(data, prob=..., axis=...):  # -> _Array1D[float64]:
    """
...
def mquantiles_cimj(
    data, prob=..., alpha=..., axis=...
):  # -> tuple[_MaskedArray[float64] | Any, _MaskedArray[float64] | Any]:
    """
