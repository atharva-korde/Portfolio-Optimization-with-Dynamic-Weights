...
@xp_capabilities(
    skip_backends=[
        ("dask.array", "can't compute chunk size"),
...
def tmean(a, limits=..., inclusive=..., axis=...):  # -> Array:
...
):  # -> float | _Array[tuple[()], float64] | NDArray[Any] | Any:
...
@xp_capabilities()
def zscore(a, axis=..., ddof=..., nan_policy=...):  # -> Array | Any:
    """
    Compute the z score.
...
@xp_capabilities()
def gzscore(a, *, axis=..., ddof=..., nan_policy=...):  # -> Array | Any:
    """
...
@xp_capabilities()
def zmap(scores, compare, axis=..., ddof=..., nan_policy=...):  # -> Array | Any:
    """
...
@xp_capabilities()
def gstd(a, axis=..., ddof=..., *, keepdims=..., nan_policy=...):  # -> Any:
    r"""
...
@xp_capabilities(
    skip_backends=[
        ("dask.array", "no quantile (take_along_axis)"),
...
@xp_capabilities(
    skip_backends=[
        ("jax.numpy", "not supported by `quantile`"),
...
def median_abs_deviation(x, axis=..., center=..., scale=..., nan_policy=...):  # -> Any:
    r"""
...
@xp_capabilities(
    skip_backends=[("dask.array", "doesn't know array size")], jax_jit=False
)
...
def f_oneway(*samples, axis=..., equal_var=...):  # -> F_onewayResult:
...
@xp_capabilities(np_only=True)
@_axis_nan_policy_factory(
    _pack_CorrelationResult,
    n_samples=2,
    result_to_tuple=_unpack_CorrelationResult,
    paired=True,
    too_small=1,
    n_outputs=3,
)
...
def kendalltau(
    x, y, *, nan_policy=..., method=..., variant=..., alternative=...
):  # -> _:
...
def unpack_TtestResult(res, _):  # -> tuple[Any, Any, Any, Any, Any, Any]:
    ...
...
@xp_capabilities(jax_jit=False, allow_dask_compute=True)
@_axis_nan_policy_factory(
    Power_divergenceResult, paired=True, n_samples=_pd_nsamples, too_small=-1
)
...
def chisquare(
    f_obs, f_exp=..., ddof=..., axis=..., *, sum_check=...
):  # -> Power_divergenceResult:
...
@_axis_nan_policy_factory(
    _tuple_to_KstestResult,
    n_samples=1,
    n_outputs=4,
    result_to_tuple=_KstestResult_to_tuple,
)
@_rename_parameter("mode", "method")
def ks_1samp(x, cdf, args=..., alternative=..., method=..., *, axis=...):  # -> _:
    """
...
@xp_capabilities(
    skip_backends=[("cupy", "no rankdata"), ("dask.array", "no rankdata")],
    jax_jit=False,
)
@_axis_nan_policy_factory(KruskalResult, n_samples=None)
def kruskal(*samples, nan_policy=..., axis=...):  # -> KruskalResult:
...
def friedmanchisquare(*samples, axis=...):  # -> FriedmanchisquareResult:
...
def brunnermunzel(
    x, y, alternative=..., distribution=..., nan_policy=..., *, axis=...
):  # -> BrunnerMunzelResult:
...
def quantile_test_iv(
    x, q, p, alternative
):  # -> tuple[NDArray[Any], ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]], Any]:
    ...
...
def rankdata(a, method=..., *, axis=..., nan_policy=...):  # -> Any:
...
@xp_capabilities(
    skip_backends=[("dask.array", "too many issues")],
    jax_jit=False,
    cpu_only=True,
    exceptions=("cupy", "jax.numpy"),
)
...
def lmoment(
    sample, order=..., *, axis=..., sorted=..., standardize=...
):  # -> Any | Array:
...
class _SimpleF:
    def __init__(self, dfn, dfd) -> None: ...
    def cdf(self, x):  # -> Any:
        ...
