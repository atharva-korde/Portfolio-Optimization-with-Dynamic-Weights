...
def geometric_discrepancy(
    sample: npt.ArrayLike, method: Literal["mindist", "mst"] = ..., metric: str = ...
) -> float:
...
def van_der_corput(
    ...
    *,
    ...
    scramble: bool = ...,
    permutations: npt.ArrayLike | None = ...,
    rng: SeedType = ...,
    workers: IntNumber = ...,
) -> np.ndarray:
...
class MultivariateNormalQMC:
    ...
    def __init__(
        ...
        *,
        cov_root: npt.ArrayLike | None = ...,
        inv_transform: bool = ...,
        engine: QMCEngine | None = ...,
        rng: SeedType = ...,
    ) -> None: ...
