...
@_ni_docstrings.docfiller
def correlate1d(
    input, weights, axis=..., output=..., mode=..., cval=..., origin=...
...
def gaussian_laplace(
    input, sigma, output=..., mode=..., cval=..., *, axes=..., **kwargs
):  # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
...
@_ni_docstrings.docfiller
def correlate(
    input, weights, output=..., mode=..., cval=..., origin=..., *, axes=...
):  # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
def uniform_filter1d(
    input, size, axis=..., output=..., mode=..., cval=..., origin=...
):  # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
...
@_ni_docstrings.docfiller
def uniform_filter(
    input, size=..., output=..., mode=..., cval=..., origin=..., *, axes=...
):  # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
