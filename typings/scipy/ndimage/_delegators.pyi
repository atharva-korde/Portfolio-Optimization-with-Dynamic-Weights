...
def affine_transform_signature(
    input, matrix, offset=..., output_shape=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def binary_closing_signature(
    input, structure=..., iterations=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def binary_dilation_signature(
    input, structure=..., iterations=..., mask=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def binary_fill_holes_signature(
    input, structure=..., output=..., origin=..., *args, **kwargs
):  # -> ModuleType:
    ...
...
def binary_hit_or_miss_signature(
    input, structure1=..., structure2=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def binary_propagation_signature(
    input, structure=..., mask=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def convolve1d_signature(
    input, weights, axis=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def fourier_ellipsoid_signature(
    input, size, n=..., axis=..., output=...
):  # -> ModuleType:
    ...

fourier_uniform_signature = ...

def fourier_gaussian_signature(
    input, sigma, n=..., axis=..., output=...
):  # -> ModuleType:
    ...

def fourier_shift_signature(
    input, shift, n=..., axis=..., output=...
):  # -> ModuleType:
    ...

def gaussian_filter_signature(
    input, sigma, order=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def gaussian_filter1d_signature(
    input, sigma, axis=..., order=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def gaussian_gradient_magnitude_signature(
    input, sigma, output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def generic_filter_signature(
    input, function, size=..., footprint=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def generic_filter1d_signature(
    input, function, filter_size, axis=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def generic_gradient_magnitude_signature(
    input, derivative, output=..., *args, **kwds
):  # -> ModuleType:
    ...

def generic_laplace_signature(
    input, derivative2, output=..., *args, **kwds
):  # -> ModuleType:
    ...

def geometric_transform_signature(
    input, mapping, output_shape=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def map_coordinates_signature(
    input, coordinates, output=..., *args, **kwds
):  # -> ModuleType:
    ...

def maximum_filter1d_signature(
    input, size, axis=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def median_filter_signature(
    input, size=..., footprint=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def morphological_gradient_signature(
    input, size=..., footprint=..., structure=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def percentile_filter_signature(
    input, percentile, size=..., footprint=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def rank_filter_signature(
    input, rank, size=..., footprint=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def rotate_signature(
    input, angle, axes=..., reshape=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def spline_filter_signature(
    input, order=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def spline_filter1d_signature(
    input, order=..., axis=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...

def uniform_filter_signature(
    input, size=..., output=..., *args, **kwds
):  # -> ModuleType:
    ...
...
def watershed_ift_signature(
    input, markers, structure=..., output=...
):  # -> ModuleType:
    ...
