...
class interp2d:
    ...
    def __init__(
        self, x, y, z, kind=..., copy=..., bounds_error=..., fill_value=...
    ) -> None: ...
...
class _PPolyBase:
    ...
    def __call__(self, x, nu=..., extrapolate=...):  # -> Any:
        """
...
class PPoly(_PPolyBase):
    ...
    def solve(
        self, y=..., discontinuity=..., extrapolate=...
    ):  # -> ndarray[tuple[()], dtype[Incomplete]]:
        """
    ...
    def roots(
        self, discontinuity=..., extrapolate=...
    ):  # -> ndarray[tuple[()], dtype[Incomplete]]:
        """
...
class NdPPoly:
    ...
    def integrate_1d(self, a, b, axis, extrapolate=...):  # -> Any | Self:
        r"""
    ...
    def integrate(
        self, ranges, extrapolate=...
    ):  # -> NDArray[Any] | NDArray[complex128 | float64] | ndarray[tuple[int], dtype[Any]] | Any:
        """
        Compute a definite integral over a piecewise polynomial.
