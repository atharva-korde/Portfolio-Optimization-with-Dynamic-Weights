...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    ):  # -> tuple[NDArray[Any], NDArray[Any], Any | NDArray[Any], NDArray[Any], int]:
        ...
    ...
    def __call__(
        self, x, nu=..., ext=...
    ):  # -> NDArray[Any] | list[list[list[Any] | Any] | Any]:
        """
    ...
    def integral(
        self, a, b
    ):  # -> list[list[list[Any] | tuple[Any, Any] | Any] | tuple[Any, Any] | Any] | tuple[Any, Any]:
    ...
    def derivatives(
        self, x
    ):  # -> list[list[Any] | list[list[Any] | Any] | Any] | list[Any]:
...
class _BivariateSplineBase:
    ...
    def __call__(
        self, x, y, dx=..., dy=..., grid=...
    ):  # -> _Array[tuple[int, int], float64] | _Array[tuple[()], float64]:
        """
    ...
    def partial_derivative(self, dx, dy):  # -> Self | _DerivedBivariateSpline:
...
class RectBivariateSpline(BivariateSpline):
    ...
    def __init__(self, x, y, z, bbox=..., kx=..., ky=..., s=..., maxit=...) -> None: ...
