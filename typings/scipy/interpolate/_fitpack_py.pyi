...
def splrep(
    ...
    per=...,
    quiet=...,
):  # -> tuple[tuple[Any, Any, int], Any, Any, Any] | tuple[Any, Any, int]:
    """
...
@xp_capabilities(out_of_scope=True)
def splev(x, tck, der=..., ext=...):  # -> Any | list[list[list[Any] | Any] | Any]:
    """
...
def splint(
    a, b, tck, full_output=...
):  # -> Any | list[list[list[Any] | tuple[Any, Any] | Any] | tuple[Any, Any] | Any] | tuple[Any, Any]:
    """
...
@xp_capabilities(out_of_scope=True)
def sproot(tck, mest=...):  # -> list[list[list[Any] | Any] | Any]:
    """
...
def insert(
    x, tck, m=..., per=...
):  # -> BSpline | tuple[Any, list[Any], Any] | tuple[Any, Any, Any]:
    """
...
@xp_capabilities(out_of_scope=True)
def splder(tck, n=...):  # -> BSpline | tuple[Any, Any | Array, Any]:
    """
