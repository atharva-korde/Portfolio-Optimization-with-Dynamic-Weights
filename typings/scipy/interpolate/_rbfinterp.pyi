...
class RBFInterpolator:
    ...
    def __getstate__(
        self,
    ):  # -> tuple[tuple[Array | Any, Any, Array | Any, Any, int | Any | None, Any, str | Any, float | Any, ndarray[tuple[int, int], dtype[signedinteger[_64Bit]]] | NDArray[signedinteger[_64Bit]] | Any], tuple[Any, Any, Any] | tuple[KDTree | Any]]:
        ...
