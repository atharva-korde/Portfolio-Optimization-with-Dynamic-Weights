...
class _BarycentricRational:
    ...
    __class_getitem__ = ...
    def __init__(self, x, y, axis=..., **kwargs) -> None: ...
    def __call__(self, z):  # -> ndarray[tuple[()], dtype[Any]]:
...
class AAA(_BarycentricRational):
    ...
    def __init__(
        self, x, y, *, rtol=..., max_terms=..., clean_up=..., clean_up_tol=...
    ) -> None: ...
    @property
    def support_points(self):  # -> _Array1D[Any]:
        ...

    @property
    def support_values(self):  # -> _Array1D[Any]:
        ...
...
class FloaterHormannInterpolator(_BarycentricRational):
    ...
    def __init__(self, points, values, *, d=..., axis=...) -> None: ...
