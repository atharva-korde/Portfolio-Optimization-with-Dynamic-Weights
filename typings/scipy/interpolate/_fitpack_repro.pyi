...
def add_knot(x, t, k, residuals):  # -> Incomplete:
    """Add a new knot.
...
def generate_knots(
    x, y, *, w=..., xb=..., xe=..., k=..., s=..., nest=..., bc_type=...
):  # -> Generator[Any | _Array1D[Incomplete], Any, None]:
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splrep(
    x, y, *, w=..., xb=..., xe=..., k=..., s=..., t=..., nest=..., bc_type=...
):  # -> BSpline:
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splprep(
    x, *, w=..., u=..., ub=..., ue=..., k=..., s=..., t=..., nest=..., bc_type=...
):  # -> tuple[Any, Array | Any] | tuple[BSpline, Any]:
    r"""
