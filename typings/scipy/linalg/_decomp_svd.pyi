...
@_apply_over_batch(("a", 2))
def svdvals(a, overwrite_a=..., check_finite=...):  # -> tuple[Any, Any, Any]:
    """
...
def diagsvd(s, M, N):  # -> NDArray[Incomplete] | Incomplete:
    """
...
@_apply_over_batch(("A", 2))
def null_space(A, rcond=..., *, overwrite_a=..., check_finite=..., lapack_driver=...):
    """
...
def subspace_angles(A, B):  # -> NDArray[Incomplete]:
    r"""
