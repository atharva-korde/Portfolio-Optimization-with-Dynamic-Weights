...
def reconstruct_interp_matrix(idx, proj):  # -> NDArray[float64] | NDArray[complex128]:
    """
...
def estimate_spectral_norm(A, its=..., rng=...):
    """
...
def estimate_spectral_norm_diff(A, B, its=..., rng=...):
    """
...
def svd(A, eps_or_k, rand=..., rng=...):  # -> tuple[Any, Any, Any]:
    """
...
def estimate_rank(A, eps, rng=...):  # -> Any:
    """
