...
def solve_sylvester(a, b, q):  # -> _Array1D[float64] | Incomplete:
    """
...
def solve_continuous_lyapunov(a, q):  # -> _Array[tuple[()], float64]:
    """
...
def solve_discrete_lyapunov(
    a, q, method=...
):  # -> ndarray[tuple[int], dtype[float64]] | _Array[tuple[()], float64]:
    """
