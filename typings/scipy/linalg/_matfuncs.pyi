...
@_apply_over_batch(("A", 2))
def logm(A, disp=...):  # -> Any | NDArray[Any] | tuple[Any | NDArray[Any], Any]:
    """
...
def expm(
    A,
):  # -> NDArray[Any] | ndarray[tuple[()], dtype[float64] | dtype[floating[_32Bit]]]:
...
def sqrtm(A, disp=..., blocksize=...):  # -> NDArray[Any] | tuple[Any, Any | float]:
    """
...
def cosm(
    A,
):  # -> NDArray[float64] | NDArray[floating[Any]] | ndarray[tuple[()], dtype[float64 | floating[_32Bit]]]:
    """
...
def sinm(
    A,
):  # -> NDArray[complex128] | NDArray[complexfloating[Any, Any]] | ndarray[tuple[()], dtype[float64 | floating[_32Bit]]]:
    """
...
@_apply_over_batch(("A", 2))
def tanm(A):  # -> ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]]:
    """
...
def coshm(
    A,
):  # -> ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[floating[Any]]]:
    """
...
@_apply_over_batch(("A", 2))
def tanhm(A):  # -> ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]]:
    """
...
def funm(
    A, func, disp=...
):  # -> Incomplete | tuple[Incomplete, float | floating[Any] | int]:
    """
...
def signm(
    A, disp=...
):  # -> Incomplete | tuple[Any, Any | float | floating[Any] | int]:
    """
...
def khatri_rao(a, b):  # -> NDArray[Any] | ndarray[tuple[int], dtype[Any]]:
    r"""
