...
def solve(
    ...
    assume_a=...,
    transposed=...,
):  # -> ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[float64]]:
    """
...
def solve_banded(
    l_and_u, ab, b, overwrite_ab=..., overwrite_b=..., check_finite=...
):  # -> NDArray[float64] | Any:
    """
...
@_apply_over_batch(("a", 2), ("b", "1|2"))
def solveh_banded(
    ab, b, overwrite_ab=..., overwrite_b=..., lower=..., check_finite=...
):  # -> NDArray[float64]:
    """
...
):  # -> ndarray[tuple[int, int], dtype[complex128 | float64]] | NDArray[complex128 | float64] | ndarray[_AnyShape, dtype[Any]]:
...
def solve_circulant(
    c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...
):  # -> NDArray[complex128 | float64] | ndarray[_AnyShape, dtype[float64]] | NDArray[complex128]:
...
def inv(a, overwrite_a=..., check_finite=..., *, assume_a=..., lower=...):
    r"""
...
):  # -> complex128 | float64 | _Array[tuple[()] | Any, float64 | complex128] | ndarray[_AnyShape, dtype[Any]] | _Array[tuple[()] | Any, Incomplete]:
    """
...
def lstsq(
    ...
    check_finite=...,
    lapack_driver=...,
):  # -> tuple[_Array[tuple[int, int], float64], Any | _Array[tuple[int], float64], Literal[0], _Array[tuple[int], float64]] | tuple[Any, Any | NDArray[Any], Any, Any] | tuple[Any, NDArray[Any], Any, None] | None:
    """
...
def pinv(
    a, *, atol=..., rtol=..., return_rank=..., check_finite=...
):  # -> tuple[Any, Any]:
    """
...
@_apply_over_batch(("a", 2))
def pinvh(
    a, atol=..., rtol=..., lower=..., return_rank=..., check_finite=...
):  # -> tuple[Any, int]:
    """
...
@_apply_over_batch(("A", 2))
def matrix_balance(
    A, permute=..., scale=..., separate=..., overwrite_a=...
):  # -> tuple[NDArray[float64], tuple[NDArray[float64], _Array1D[int_]]] | tuple[NDArray[float64], NDArray[float64]] | tuple[Any, tuple[NDArray[Any], Any]] | tuple[Any, ndarray[_AnyShape, dtype[Any]]]:
    """
...
def matmul_toeplitz(
    c_or_cr, x, check_finite=..., workers=...
):  # -> ndarray[tuple[int, int], dtype[complex128 | float64]] | NDArray[complex128 | float64]:
