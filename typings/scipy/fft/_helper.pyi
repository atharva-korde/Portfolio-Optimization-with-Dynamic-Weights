...
def prev_fast_len(target, real=...):  # -> None:
...
@xp_capabilities()
def fftfreq(n, d=..., *, xp=..., device=...):  # -> NDArray[floating[Any]]:
...
@xp_capabilities()
def rfftfreq(n, d=..., *, xp=..., device=...):  # -> NDArray[floating[Any]]:
    """Return the Discrete Fourier Transform sample frequencies
