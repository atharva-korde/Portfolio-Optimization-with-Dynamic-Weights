...
class _minmax_mixin:
    ...
    def max(self, axis=..., out=..., *, explicit=...):  # -> Any:
    ...
    def min(self, axis=..., out=..., *, explicit=...):  # -> Any:
    ...
    def nanmax(self, axis=..., out=..., *, explicit=...):  # -> Any:
    ...
    def nanmin(self, axis=..., out=..., *, explicit=...):  # -> Any:
    ...
    def argmax(
        self, axis=..., out=..., *, explicit=...
    ):  # -> _Array1D[Incomplete] | int:
