...
def find(
    A,
):  # -> tuple[ndarray[_AnyShape, dtype[signedinteger[_32Bit] | signedinteger[_64Bit]]] | Any | ndarray[_AnyShape, dtype[signedinteger[_64Bit]]] | ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[intp]], Any, ndarray[_AnyShape, dtype[float64 | int_ | numpy.bool[builtins.bool]]] | ndarray[_AnyShape, dtype[Any]] | Any]:
