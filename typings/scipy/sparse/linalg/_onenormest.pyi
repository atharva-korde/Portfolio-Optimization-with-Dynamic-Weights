...
):  # -> tuple[Any | _Array1D[Incomplete] | Literal[0], ...] | tuple[Any | Literal[0], ...] | tuple[Any | Literal[0], _Array1D[Incomplete]] | tuple[Any | Literal[0]] | Any | Literal[0]:
    """
...
def elementary_vector(n, i):  # -> _Array1D[Incomplete]:
    ...
