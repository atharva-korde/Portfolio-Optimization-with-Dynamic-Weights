...
def splu(
    A, permc_spec=..., diag_pivot_thresh=..., relax=..., panel_size=..., options=...
):
    """
...
def spsolve_triangular(
    A, b, lower=..., overwrite_A=..., overwrite_b=..., unit_diagonal=...
):
    """
...
def is_sptriangular(
    A,
):  # -> tuple[Any, Any] | tuple[builtins.bool, builtins.bool] | tuple[Literal[False], Literal[False]] | tuple[numpy.bool[builtins.bool] | Any, numpy.bool[builtins.bool] | Any]:
