...
class LinearOperator:
    ...
    def matvec(self, x):  # -> NDArray[Any] | ndarray[tuple[int, int], dtype[Any]]:
    ...
    def rmatvec(
        self, x
    ):  # -> NDArray[Any] | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]]:
    ...
    def matmat(
        self, X
    ):  # -> matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
    ...
    def rmatmat(
        self, X
    ):  # -> matrix[_AnyShape, dtype[Any]] | matrix[Any, Any] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | Any:
    ...
    def __mul__(
        self, x
    ):  # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[_AnyShape, dtype[Any]] | matrix[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]]:
        ...
    ...
    def __pow__(self, p):  # -> _PowerLinearOperator | NotImplementedType:
        ...

    def __add__(self, x):  # -> _SumLinearOperator | NotImplementedType:
        ...

    def __neg__(self):  # -> _ScaledLinearOperator:
        ...

    def __sub__(self, x):  # -> _SumLinearOperator | NotImplementedType:
        ...
...
class _AdjointMatrixOperator(MatrixLinearOperator):
    def __init__(self, adjoint_array) -> None: ...
    @property
    def dtype(self): ...
