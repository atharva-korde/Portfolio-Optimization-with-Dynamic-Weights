...
def expm(
    A,
):  # -> ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | csc_array | Any | ndarray[_AnyShape, dtype[float64]] | NotImplementedType:
    """
...
def matrix_power(A, power):  # -> coo_array | coo_matrix | dia_array | Any | dia_matrix:
    """
