...
def ismatrix(t) -> bool: ...
def isdense(x) -> bool: ...
def validateaxis(axis, *, ndim=...) -> tuple[int, ...] | None: ...
...
def convert_pydata_sparse_to_scipy(
    arg: Any, target_format: None | Literal["csc", "csr"] = ..., accept_fv: Any = ...
...
def asmatrix(data, dtype=...):  # -> matrix[Any, Any] | matrix[_2D, dtype[Any]]:
    ...
