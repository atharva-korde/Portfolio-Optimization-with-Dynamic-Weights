...
class _dia_base(_data_matrix):
    ...
    def count_nonzero(self, axis=...):  # -> intp:
        ...

    def sum(self, axis=..., dtype=..., out=...):  # -> Incomplete | _Matrix[Incomplete]:
        ...

    def multiply(self, other):  # -> dia_array | NotImplementedType | Self:
        ...
    ...
    def diagonal(
        self, k=...
    ):  # -> ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | NDArray[float64 | int_ | numpy.bool[builtins.bool]] | ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[float64]]:
        ...
