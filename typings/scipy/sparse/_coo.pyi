...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    _allow_nd = ...
    def __init__(
        self, arg1, shape=..., dtype=..., copy=..., *, maxprint=...
    ) -> None: ...
    @property
    def row(
        self,
    ):  # -> NDArray[signedinteger[_32Bit] | signedinteger[_64Bit]] | ndarray[tuple[int], dtype[signedinteger[_32Bit] | signedinteger[_64Bit]]] | ndarray[tuple[int], dtype[signedinteger[_64Bit]]] | ndarray[_AnyShape, dtype[signedinteger[_64Bit]]] | NDArray[Any] | NDArray[intp] | ndarray[_AnyShape, dtype[Any]]:
        ...
    ...
    def count_nonzero(self, axis=...):  # -> intp | NDArray[intp]:
        ...

    def transpose(
        self, axes=..., copy=...
    ):  # -> Self | <subclass of _coo_base* and sparray> | _coo_base:
        ...
    ...
    def diagonal(
        self, k=...
    ):  # -> ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | _Array1D[float64]:
        ...

    def __getitem__(self, key):  # -> Any | coo_array:
        ...
    ...
    def dot(
        self, other
    ):  # -> ndarray[tuple[()], dtype[Any]] | ndarray[tuple[()], Any] | Any | coo_array:
