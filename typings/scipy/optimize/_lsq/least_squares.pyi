...
def call_minpack(
    fun, x0, jac, ftol, xtol, gtol, max_nfev, x_scale, jac_method=...
):  # -> OptimizeResult:
    ...

def prepare_bounds(
    bounds, n
):  # -> tuple[ndarray[tuple[int], dtype[Any]] | NDArray[Any], ndarray[tuple[int], dtype[Any]] | NDArray[Any]]:
    ...

def check_tolerance(
    ftol, xtol, gtol, method
):  # -> tuple[Any | Literal[0], Any | Literal[0], Any | Literal[0]]:
    ...

def check_x_scale(
    x_scale, x0, method
):  # -> ndarray[tuple[int], dtype[Any]] | NDArray[Any] | float | int | str:
    ...

def check_jac_sparsity(jac_sparsity, m, n):  # -> tuple[NDArray[Any] | Any, Any] | None:
    ...
...
def construct_loss_function(
    m, loss, f_scale
):  # -> Callable[..., Any | _Array[tuple[int, int], float64]] | None:
    ...
