...
):  # -> tuple[Any, float, Literal[0]] | tuple[Any, Any, int]:
...
def solve_trust_region_2d(
    B, g, Delta
):  # -> tuple[Any, Literal[True]] | tuple[Any, Literal[False]]:
...
def build_quadratic_1d(
    J, g, s, diag=..., s0=...
):  # -> tuple[Any, Any, Any] | tuple[Any, Incomplete]:
...
def in_bounds(x, lb, ub):  # -> numpy.bool[builtins.bool]:
...
def compute_jac_scale(
    J, scale_inv_old=...
):  # -> tuple[NDArray[float64] | Any, NDArray[float64] | Any | NDArray[Incomplete]]:
