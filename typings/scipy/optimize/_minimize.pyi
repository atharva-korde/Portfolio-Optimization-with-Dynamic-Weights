...
class _Patch_Callback_Equal_Variables:
    def __init__(self, callback, i_fixed, x_fixed) -> None: ...
    def __call__(self, intermediate_result): ...

class _Remove_From_Func:
    """Wraps a function such that fixed variables need not be passed in"""

    def __init__(self, fun_in, i_fixed, x_fixed, min_dim=..., remove=...) -> None: ...
    def __call__(self, x_in, *args, **kwargs):  # -> ndarray[_AnyShape, dtype[Any]]:
        ...
...
def standardize_constraints(
    constraints, x0, meth
):  # -> list[NonlinearConstraint | LinearConstraint | dict[Any, Any]] | list[Any]:
