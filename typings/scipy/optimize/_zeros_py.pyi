...
def newton(
    ...
    full_output=...,
    disp=...,
):  # -> result | NDArray[Any] | NDArray[float64] | tuple[NDArray[float64] | Any, RootResults] | tuple[Any, RootResults]:
    """
...
class TOMS748Solver:
    ...
    def start(
        self, f, a, b, args=...
    ):  # -> tuple[Literal[0], Any] | tuple[Literal[1], float]:
    ...
    def iterate(
        self,
    ):  # -> tuple[Literal[0], float | Any] | tuple[Literal[0], float] | tuple[Literal[0, -2, 1], float]:
