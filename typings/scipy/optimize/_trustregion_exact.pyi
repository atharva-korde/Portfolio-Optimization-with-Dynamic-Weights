...
def estimate_smallest_singular_value(U):  # -> tuple[Any, Any]:
...
def singular_leading_submatrix(A, U, k):  # -> tuple[Any, _Array1D[float64]]:
    """
...
class IterativeSubproblem(BaseQuadraticSubproblem):
    ...
    EPS = ...
    def __init__(
        self, x, fun, jac, hess, hessp=..., k_easy=..., k_hard=..., maxiter=...
    ) -> None: ...
    def solve(self, tr_radius):  # -> tuple[Any | _Array1D[float64], bool]:
