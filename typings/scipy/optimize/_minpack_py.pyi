...
def fsolve(
    ...
    factor=...,
    diag=...,
):  # -> tuple[Any, dict[str, Any | None], Any, Any]:
    """
...
def check_gradient(
    fcn, Dfcn, x0, args=..., col_deriv=...
):  # -> tuple[Any, _Array[tuple[int], Incomplete]]:
    """Perform a simple check on the gradient for correctness."""
    ...

def fixed_point(func, x0, args=..., xtol=..., maxiter=..., method=...):  # -> Array:
    """
