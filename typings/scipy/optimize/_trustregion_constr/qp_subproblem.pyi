...
def sphere_intersections(
    z, d, trust_radius, entire_line=...
):  # -> tuple[Literal[0], Literal[0], Literal[False]] | tuple[float | Literal[0], float | Literal[1], Literal[True]] | tuple[Any | int, Any | int, bool]:
...
def box_intersections(
    z, d, lb, ub, entire_line=...
):  # -> tuple[Literal[0], Literal[0], Literal[False]] | tuple[int | Any, int | Any, bool]:
...
def box_sphere_intersections(
    z, d, lb, ub, trust_radius, entire_line=..., extra_info=...
):  # -> tuple[Incomplete, Incomplete, bool, dict[str, Any], dict[str, Any]] | tuple[Incomplete, Incomplete, bool]:
