...
def line_search_wolfe1(
    ...
    amin=...,
    xtol=...,
):  # -> tuple[Any | None, int, int, Any, Any, Any]:
    """
...
def line_search_wolfe2(
    ...
    extra_condition=...,
    maxiter=...,
):  # -> tuple[Any | float | None, int, int, Any, Any | None, None]:
...
def scalar_search_wolfe2(
    ...
    extra_condition=...,
    maxiter=...,
):  # -> tuple[Any | float | None, Any, Any | None, Any | None]:
    """Find alpha that satisfies strong Wolfe conditions.
...
def line_search_BFGS(
    f, xk, pk, gfk, old_fval, args=..., c1=..., alpha0=...
):  # -> tuple[int | Any | None, int, Literal[0], Any]:
    """
...
):  # -> tuple[int, Any] | tuple[Any, Any] | tuple[None, Any]:
