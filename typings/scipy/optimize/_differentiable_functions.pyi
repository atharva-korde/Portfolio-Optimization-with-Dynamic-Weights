...
class _ScalarHessWrapper:
    ...
    def __init__(
        self, hess, x0=..., grad=..., args=..., finite_diff_options=...
    ) -> None: ...
...
class ScalarFunction:
    ...
    def fun(self, x):  # -> generic[Any] | complex | str | bytes | memoryview[int]:
        ...

    def grad(self, x): ...
    def hess(
        self, x
    ):  # -> HessianUpdateStrategy | object | csr_array | NDArray[Any] | None:
        ...

    def fun_and_grad(
        self, x
    ):  # -> tuple[Any | generic[Any] | complex | str | bytes | memoryview[int], Any]:
        ...
...
class _VectorJacWrapper:
    ...
    def __init__(
        self, jac, fun=..., finite_diff_options=..., sparse_jacobian=...
    ) -> None: ...
...
class _VectorHessWrapper:
    ...
    def __call__(
        self, x, v, J0=..., **kwds
    ):  # -> csr_array | LinearOperator | NDArray[Any] | None:
        ...
...
class VectorFunction:
    ...
    def jac(
        self, x
    ):  # -> int_ | numpy.bool[builtins.bool] | float64 | ndarray[tuple[int], dtype[int_ | numpy.bool[builtins.bool] | float64]] | ndarray[tuple[int, int], dtype[int_ | numpy.bool[builtins.bool] | float64]] | ndarray[_AnyShape, dtype[int_ | numpy.bool[builtins.bool] | float64]] | csr_matrix | csr_array | <subclass of _csr_base* and sparray> | _csr_base | object | LinearOperator | _Array1D[float64] | _Array[tuple[int, int], float64] | ndarray[_AnyShape, dtype[float64]]:
        ...

    def hess(
        self, x, v
    ):  # -> ndarray[_AnyShape, dtype[int_ | numpy.bool[builtins.bool]]] | csr_array | LinearOperator | NDArray[Any] | HessianUpdateStrategy | None:
        ...
...
class LinearVectorFunction:
    ...
    def fun(self, x):  # -> NDArray[Any] | NotImplementedType | csr_array:
        ...
