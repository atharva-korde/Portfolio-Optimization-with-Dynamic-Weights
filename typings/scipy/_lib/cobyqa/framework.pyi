...
class TrustRegion:
    ...
    @property
    def x_best(self):  # -> NDArray[float64]:
        """
    ...
    @property
    def cub_best(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        """
    ...
    @property
    def ceq_best(self):  # -> ndarray[_AnyShape, dtype[Any]]:
        """
    ...
    def get_constraint_linearizations(
        self, x
    ...
    def get_geometry_step(
        self, k_new, options
    ):  # -> ndarray[Any, Any] | NDArray[float64]:
        """
