...
class Interpolation:
    ...
    @property
    def xpt(self):  # -> _Array[tuple[int, int], float64]:
        """
    ...
    def point(self, k):  # -> NDArray[float64]:
        """
...
def build_system(
    interpolation,
):  # -> tuple[Any, Any, Any] | tuple[_Array[tuple[int, int], float64], _Array1D[float64], tuple[Any, Any]]:
    """
...
class Quadratic:
    ...
    def update(self, interpolation, k_new, dir_old, values_diff):  # -> Incomplete:
        """
    ...
    @staticmethod
    def solve_systems(interpolation, rhs):  # -> tuple[Any, Incomplete]:
        """
...
class Models:
    ...
    @property
    def fun_val(self):  # -> _Array[tuple[int], Any]:
        """
    ...
    @property
    def cub_val(self):  # -> _Array[tuple[int, int], Any]:
        """
    ...
    @property
    def ceq_val(self):  # -> _Array[tuple[int, int], Any]:
        """
    ...
    def cub_grad(self, x, mask=...):  # -> ndarray[tuple[int, int], dtype[Any]]:
        """
    ...
    def cub_hess(self, mask=...):  # -> ndarray[tuple[int, int, int], dtype[Any]]:
        """
    ...
    def cub_hess_prod(self, v, mask=...):  # -> ndarray[tuple[int, int], dtype[Any]]:
        """
    ...
    def ceq_grad(self, x, mask=...):  # -> ndarray[tuple[int, int], dtype[Any]]:
        """
        Evaluate the gradients of the quadratic models of the nonlinear
    ...
    def ceq_hess(self, mask=...):  # -> ndarray[tuple[int, int, int], dtype[Any]]:
        """
        Evaluate the Hessian matrices of the quadratic models of the nonlinear
        equality functions.
    ...
    def ceq_hess_prod(self, v, mask=...):  # -> ndarray[tuple[int, int], dtype[Any]]:
        """
        Evaluate the right product of the Hessian matrices of the quadratic
    ...
    def update_interpolation(
        self, k_new, x_new, fun_val, cub_val, ceq_val
    ):  # -> Incomplete:
        """
