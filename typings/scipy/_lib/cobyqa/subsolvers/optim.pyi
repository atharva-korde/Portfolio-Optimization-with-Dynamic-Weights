...
def tangential_byrd_omojokun(
    grad, hess_prod, xl, xu, delta, debug, **kwargs
):  # -> NDArray[Any]:
    r"""
...
def constrained_tangential_byrd_omojokun(
    grad, hess_prod, xl, xu, aub, bub, aeq, delta, debug, **kwargs
):
    r"""
...
def qr_tangential_byrd_omojokun(
    aub, aeq, free_xl, free_xu, free_ub
):  # -> tuple[intp, Any | NDArray[Any] | tuple[Any | NDArray[Any], NDArray[Any]] | tuple[Any, Any]]:
    ...

def qr_normal_byrd_omojokun(
