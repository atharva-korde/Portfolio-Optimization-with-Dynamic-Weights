...
class BoundConstraints:
    ...
    def maxcv(self, x):  # -> NDArray[Any] | Any:
        """
    ...
    def violation(self, x):  # -> NDArray[Any] | Any:
        ...
...
class LinearConstraints:
    ...
    @property
    def a_ub(self):  # -> _Array[tuple[int, int], float64] | NDArray[float64]:
        """
    ...
    @property
    def b_ub(self):  # -> _Array1D[float64] | NDArray[float64]:
        """
    ...
    @property
    def a_eq(self):  # -> _Array[tuple[int, int], float64] | NDArray[float64]:
        """
    ...
    @property
    def b_eq(self):  # -> _Array1D[float64] | NDArray[float64]:
        """
...
class NonlinearConstraints:
    ...
    @property
    def m_ub(self):  # -> int | signedinteger[_NBitIntP]:
        """
    ...
    @property
    def m_eq(self):  # -> int | signedinteger[_NBitIntP]:
        """
...
class Problem:
    ...
    def __call__(
        self, x, penalty=...
    ):  # -> tuple[float, NDArray[Incomplete], NDArray[Incomplete]]:
        """
    ...
    @property
    def x0(self):  # -> ndarray[_AnyShape, dtype[Any]] | NDArray[float64]:
        """
        Initial guess.
    ...
    @property
    def m_bounds(self):  # -> signedinteger[_NBitIntP]:
        """
    ...
    @property
    def m_nonlinear_ub(self):  # -> int | signedinteger[_NBitIntP]:
        """
        Number of nonlinear inequality constraints.
    ...
    @property
    def m_nonlinear_eq(self):  # -> int | signedinteger[_NBitIntP]:
        """
        Number of nonlinear equality constraints.
    ...
    def type(
        self,
    ):  # -> Literal['nonlinearly constrained', 'linearly constrained', 'bound-constrained', 'unconstrained']:
        """
        Type of the problem.
    ...
    def build_x(self, x):  # -> _Array1D[float64]:
        """
    ...
    def best_eval(
        self, penalty
    ):  # -> tuple[Any | ndarray[_AnyShape, dtype[Any]], Any, Any]:
        """
