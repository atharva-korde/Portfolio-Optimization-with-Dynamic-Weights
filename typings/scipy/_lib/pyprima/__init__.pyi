...
def get_constraint_type(
    constraint,
):  # -> Literal[ConstraintType.LINEAR_DICT, ConstraintType.NONLINEAR_DICT, ConstraintType.LINEAR_OBJECT, ConstraintType.NONLINEAR_OBJECT]:
    ...

def process_constraints(
    constraints,
):  # -> tuple[None, None] | tuple[LinearConstraint | Any | None, Callable[..., _Array1D[float64] | NDArray[float64]] | None]:
    ...
