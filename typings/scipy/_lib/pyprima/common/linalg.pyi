...
def inprod(x, y):  # -> Incomplete | Literal[0]:
    ...

def matprod12(x, y):  # -> _Array1D[float64]:
    ...

def matprod21(x, y):  # -> _Array1D[float64]:
    ...
...
def matprod(
    x, y
):  # -> Incomplete | _Array1D[float64] | _Array[tuple[int, int], float64] | Literal[0]:
    ...

def outprod(x, y):  # -> _Array2D[Any] | _Array[tuple[int, int], float64]:
    ...

def lsqr(A, b, Q, Rdiag):  # -> _Array1D[float64]:
    ...

def hypot(x1, x2):  # -> Any | Literal[0]:
    ...

def norm(x):  # -> floating[Any] | Incomplete:
    ...
...
def inv(A):  # -> _Array[tuple[int, int], float64] | ndarray[_AnyShape, dtype[float64]]:
    ...

def qr(A):  # -> tuple[_Array2D[float64], Any, NDArray[Incomplete]]:
    ...

def primasum(x, axis=...):  # -> int | _Array1D[float64] | None:
    """
