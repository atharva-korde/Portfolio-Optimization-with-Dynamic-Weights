...
def pickle_function(
    func,
):  # -> tuple[Callable[..., MethodType | ModuleType | Any], tuple[Any | None, Any | None, Any | None]]:
    ...
...
@contextlib.contextmanager
def set_state(state):  # -> Generator[None, Any, None]:
    """
...
def create_multimethod(
    *args, **kwargs
):  # -> Callable[..., _Wrapped[Callable[..., Any], tuple[Dispatchable, ...], Callable[..., Any], Any]]:
    """
...
):  # -> _Wrapped[Callable[..., Any], tuple[Dispatchable, ...], Callable[..., Any], Any]:
    """
    Generates a multimethod.
...
def get_defaults(f):  # -> tuple[dict[Any, Any], tuple[Any, ...], set[Any]]:
    ...
...
def all_of_type(
    arg_type,
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[Dispatchable, ...]]]:
    """
...
def wrap_single_convertor(
    convert_single,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], NotImplementedType | list[Any]]:
    """
