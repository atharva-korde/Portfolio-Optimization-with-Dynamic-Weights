...
def max(
    x: Array, /, *, axis: int | tuple[int, ...] | None = ..., keepdims: bool = ...
) -> Array: ...
def min(
    x: Array, /, *, axis: int | tuple[int, ...] | None = ..., keepdims: bool = ...
) -> Array: ...
...
def flip(
    x: Array, /, *, axis: int | tuple[int, ...] | None = ..., **kwargs: object
) -> Array: ...
def roll(
    x: Array,
    /,
...
def reshape(
    x: Array, /, shape: tuple[int, ...], *, copy: bool | None = ..., **kwargs: object
) -> Array: ...
def arange(
    start: float,
    /,
...
def astype(
    x: Array, dtype: DType, /, *, copy: bool = ..., device: Device | None = ...
) -> Array: ...
...
def isdtype(
    dtype: DType, kind: DType | str | tuple[DType | str, ...], *, _tuple: bool = ...
) -> bool:
    """
...
def take(
    x: Array, indices: Array, /, *, axis: int | None = ..., **kwargs: object
) -> Array: ...
