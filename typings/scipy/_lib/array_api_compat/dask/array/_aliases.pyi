...
def astype(
    x: Array, dtype: DType, /, *, copy: py_bool = ..., device: Device | None = ...
) -> Array:
    """
...
def clip(
    x: Array, /, min: float | Array | None = ..., max: float | Array | None = ...
) -> Array:
    """
...
def sort(
    x: Array, /, *, axis: int = ..., descending: py_bool = ..., stable: py_bool = ...
) -> Array:
    """
...
def count_nonzero(
    x: Array, axis: int | None = ..., keepdims: py_bool = ...
) -> Array: ...
