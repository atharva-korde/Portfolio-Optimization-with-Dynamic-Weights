...
if sys.version_info >= (3, 14):
    def wrapped_inspect_signature(callable):  # -> Signature:
...
class _ScalarFunctionWrapper:
    ...
    def __init__(self, f, args=...) -> None: ...
    def __call__(self, x):  # -> generic[Any] | complex | str | bytes | memoryview[int]:
        ...
...
def rng_integers(gen, low, high=..., size=..., dtype=..., endpoint=...):  # -> Any:
    """
...
@contextmanager
def ignore_warns(expected_warning, *, match=...):  # -> Generator[None, Any, None]:
    ...
