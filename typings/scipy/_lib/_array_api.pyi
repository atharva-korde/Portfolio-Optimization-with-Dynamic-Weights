...
def assert_array_almost_equal(
    actual, desired, decimal=..., *args, **kwds
):  # -> Any | None:
...
def xp_promote(
    *args, broadcast=..., force_floating=..., xp
):  # -> tuple[Any, ...] | Array | tuple[Array | Any, ...]:
    """
...
def make_xp_pytest_marks(*funcs, capabilities_table=...):  # -> list[Any]:
