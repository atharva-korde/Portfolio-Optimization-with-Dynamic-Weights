...
def cov(m: Array, /, *, xp: ModuleType | None = ...) -> Array:
    """
...
def create_diagonal(
    x: Array, /, *, offset: int = ..., xp: ModuleType | None = ...
) -> Array:
    """
...
def expand_dims(
    a: Array, /, *, axis: int | tuple[int, ...] = ..., xp: ModuleType | None = ...
) -> Array:
    """
...
def sinc(x: Array, /, *, xp: ModuleType | None = ...) -> Array:
    r"""
...
def partition(
    a: Array, kth: int, /, axis: int | None = ..., *, xp: ModuleType | None = ...
) -> Array:
    """
