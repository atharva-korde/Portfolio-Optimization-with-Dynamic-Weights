...
class KDTree(cKDTree):
    ...
    def query(
        self, x, k=..., eps=..., p=..., distance_upper_bound=..., workers=...
    ):  # -> tuple[Any, signedinteger[_NBitIntP] | Any]:
    ...
    def query_ball_point(
        self, x, r, p=..., eps=..., workers=..., return_sorted=..., return_length=...
    ):
...
def distance_matrix(
    x, y, p=..., threshold=...
):  # -> Any | _Array[tuple[int, int], Incomplete]:
