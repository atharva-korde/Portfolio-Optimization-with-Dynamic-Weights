...
_FACTORIALK_LIMITS_64BITS = ...
_FACTORIALK_LIMITS_32BITS = ...

def diric(x, n):  # -> _Array[tuple[()], Incomplete]:
...
def lqmn(
    m, n, z
):  # -> tuple[ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]]]:
...
):  # -> ndarray[Any, Any] | float64 | Any | Literal[1]:
...
def perm(N, k, exact=...):  # -> int | ndarray[Any, Any] | float64 | Any:
...
def factorialk(n, k, exact=..., extend=...):
...
def stirling2(N, K, *, exact=...):  # -> Any | NDArray[Any]:
