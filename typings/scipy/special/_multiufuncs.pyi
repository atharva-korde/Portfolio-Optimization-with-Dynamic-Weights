...
def _(
    diff_n,
):  # -> dict[str, list[tuple[Literal[0], Literal[1], Literal[-1]] | tuple[()]]]:
    ...
...
def _(
    branch_cut, norm, diff_n
):  # -> dict[str, list[tuple[Literal[0], Literal[1], Literal[-1]] | tuple[()]]]:
    ...

@assoc_legendre_p_all._override_resolve_out_shapes
def _(
    n, m, z_shape, branch_cut_shape, nout, **kwargs
):  # -> tuple[tuple[_ComplexLike, Any, *tuple[Any, ...], Any]]:
    ...
...
def _(
    diff_n,
):  # -> dict[str, list[tuple[Literal[0], Literal[1], Literal[-2], Literal[-1]] | tuple[()]]]:
    ...

@sph_harm_y_all._override_resolve_out_shapes
def _(
    n, m, theta_shape, phi_shape, nout, **kwargs
):  # -> tuple[tuple[_ComplexLike, Any, *tuple[Any, ...], Any, Any]]:
    ...
