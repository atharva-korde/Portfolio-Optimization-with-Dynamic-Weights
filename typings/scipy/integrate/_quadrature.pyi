...
@xp_capabilities(
    skip_backends=[("jax.numpy", "JAX arrays do not support item assignment")]
)
...
@xp_capabilities()
def cumulative_trapezoid(y, x=..., dx=..., axis=..., initial=...):  # -> Any:
    """
...
@xp_capabilities(np_only=True)
def simpson(y, x=..., *, dx=..., axis=...):  # -> NDArray[float64] | float:
    """
...
@xp_capabilities(allow_dask_compute=1, skip_backends=[("jax.numpy", "item assignment")])
def cumulative_simpson(y, *, x=..., dx=..., axis=..., initial=...):  # -> Any:
    r"""
...
@xp_capabilities(np_only=True)
def newton_cotes(rn, equal=...):  # -> tuple[NDArray[float64], float] | tuple[Any, Any]:
    r"""
...
@xp_capabilities(
    skip_backends=[("dask.array", "Dask arrays are confused about their shape")],
    jax_jit=False,
)
def qmc_quad(
    func, a, b, *, n_estimates=..., n_points=..., qrng=..., log=...
):  # -> QMCQuadResult:
    """
