...
def estimate_fun_jac(
    fun, x, y, p, f0=...
):  # -> tuple[_Array[tuple[int, int, int], float64], _Array[tuple[int, int, int], float64] | None]:
...
def estimate_bc_jac(
    bc, ya, yb, p, bc0=...
):  # -> tuple[_Array[tuple[int, int], float64], _Array[tuple[int, int], float64], _Array[tuple[int, int], float64] | None]:
...
def stacked_matmul(a, b):  # -> _Array[tuple[int, int, int], float64] | Any:
...
):  # -> tuple[Callable[..., tuple[Any, Any, Any, Any]], Callable[..., csc_matrix]]:
...
):  # -> tuple[Callable[..., NDArray[Any] | Any], Callable[..., NDArray[Any]], Callable[..., tuple[NDArray[Any] | Any, NDArray[Any]]] | Any, Callable[..., tuple[NDArray[Any], NDArray[Any], None]] | Callable[..., tuple[NDArray[Any], NDArray[Any], NDArray[Any]]] | Any]:
