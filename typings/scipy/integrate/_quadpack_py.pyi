...
@xp_capabilities(np_only=True)
def dblquad(
    func, a, b, gfun, hfun, args=..., epsabs=..., epsrel=...
):  # -> tuple[Any, int, dict[str, int]] | tuple[Any, int]:
    """
...
@xp_capabilities(np_only=True)
def tplquad(
    func, a, b, gfun, hfun, qfun, rfun, args=..., epsabs=..., epsrel=...
):  # -> tuple[Any, int, dict[str, int]] | tuple[Any, int]:
    """
...
@xp_capabilities(np_only=True)
def nquad(
    func, ranges, args=..., opts=..., full_output=...
):  # -> tuple[Any, int, dict[str, int]] | tuple[Any, int]:
    r"""
