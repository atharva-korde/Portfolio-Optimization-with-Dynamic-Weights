...
def prepare_events(
    events,
):  # -> tuple[tuple[Callable[..., object]] | Any, _Array1D[float64], _Array1D[float64]]:
    """Standardize event functions and extract attributes."""
    ...

def solve_event_equation(event, sol, t_old, t):  # -> tuple[Any, RootResults]:
...
def handle_events(
    sol, events, active_events, event_count, max_events, t_old, t
):  # -> tuple[Any, ndarray[_AnyShape, dtype[Any]], bool]:
...
def find_active_events(g, g_new, direction):  # -> ndarray[tuple[int], dtype[intp]]:
