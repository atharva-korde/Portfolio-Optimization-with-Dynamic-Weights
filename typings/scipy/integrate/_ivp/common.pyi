...
class OdeSolution:
    ...
    def __call__(self, t):  # -> ndarray[_AnyShape, dtype[Any]]:
...
def num_jac(
    fun, t, y, f, threshold, factor, sparsity=...
):  # -> tuple[_Array[tuple[int, int], float64], Any] | tuple[Any, Any] | tuple[csc_array, Any]:
