...
class IndentLoggerAdapter(logging.LoggerAdapter):
    def process(
        self, msg, kwargs
    ):  # -> tuple[LiteralString | Any, MutableMapping[str, Any]]:
        ...
...
def format_annual_financial_statement(
    level_detail, annual_dicts, annual_order, ttm_dicts=..., ttm_order=...
):  # -> DataFrame:
    """
...
def camel2title(
    strings: List[str], sep: str = ..., acronyms: Optional[List[str]] = ...
) -> List[str]: ...
...
def parse_actions(data):  # -> tuple[DataFrame, DataFrame, DataFrame]:
    ...
...
def fix_Yahoo_returning_live_separate(
    quotes, interval, tz_exchange, prepost, repair=..., currency=...
...
def format_history_metadata(md, tradingPeriodsOnly=...):  # -> dict[Any, Any]:
    ...
...
def generate_list_table_from_dict(
    data: dict, bullets: bool = ..., title: str = ...
) -> str:
    """
...
def generate_list_table_from_dict_universal(
    data: dict, bullets: bool = ..., title: str = ..., concat_keys=...
) -> str:
    """
    Generate a list-table for the docstring showing permitted keys/values.
    """
