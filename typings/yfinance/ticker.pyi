...
class Ticker(TickerBase):
    ...
    @property
    def recommendations(self):  # -> dict[Hashable, Any] | DataFrame:
        ...

    @property
    def recommendations_summary(self):  # -> dict[Hashable, Any] | DataFrame:
        ...

    @property
    def upgrades_downgrades(self):  # -> dict[Hashable, Any] | DataFrame:
        ...
