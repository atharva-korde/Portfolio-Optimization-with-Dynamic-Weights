...
For dynamically changing weights, the following table shows the values of the Sharpe Ratios for various rebalancing frequencies as columns with various historical observation periods as rows:
