...
def annualized_metrics(returns, period_length):
...
def main(printit = False):
    ...
    for ROLLING_WINDOW in ROLLING_WINDOW_OPTIONS:
        ...
        for REBALANCING_FREQ in REBALANCING_FREQ_OPTIONS:
            ...
            (strategy_returns, benchmark_returns, weights_df) = run_backtest(returns, ROLLING_WINDOW, REBALANCING_FREQ, RISK_FREE_RATE)
